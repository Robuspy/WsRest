...
import com.pablosrl.data.Linea;
import com.pablosrl.util.AppUtils;

@Path("WsArticuloLinea")
@Consumes(MediaType.APPLICATION_JSON)
@Produces(MediaType.APPLICATION_JSON)
public class WsArticuloLinea {
	Logger logger  = Logger.getLogger(WsArticuloLinea.class);

	public WsArticuloLinea() {
		BasicConfigurator.configure();
	}

	@GET
	@Produces(MediaType.APPLICATION_JSON)
	public List<Linea> getIt() {
		Linea c = null;
		List<Linea> lista = new ArrayList<>();

		String sql = "SELECT COD_EMPRESA, COD_LINEA, DESCRIPCION FROM WSV_LINEAS";
