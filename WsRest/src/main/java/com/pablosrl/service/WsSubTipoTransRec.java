...
@Path("WsSubTipoTransRec")
@Consumes(MediaType.APPLICATION_JSON)
@Produces(MediaType.APPLICATION_JSON)
public class WsSubTipoTransRec {

    Logger logger = Logger.getLogger(WsSubTipoTransRec.class);

    public WsSubTipoTransRec() {
    ...
    public List<SubTipoTrans> getIt() {
        ...
        String sql = "select COD_EMPRESA, TIP_DOCUMENTO, SUBTIPO_TRANS, "
                + "DESCRIPCION, CARGA_VALORES, CARGA_OTROS "
                + "from wsv_subtipotrans_rec ";
