...
public class ArticulosExistencias {
	...
	public BigDecimal getCantBloqueo() {
		return cantBloqueo;
	}
	public void setCantBloqueo(BigDecimal cantBloqueo) {
		this.cantBloqueo = cantBloqueo;
	}
	public BigDecimal getCantDispon() {
		return cantDispon;
	}
	public void setCantDispon(BigDecimal cantDispon) {
